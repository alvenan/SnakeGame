...
/******************************************************************************
 DISPLAY 64x128 defs
 ******************************************************************************/
#define DISPLAY_NUMBER_OF_LINES     64
#define DISPLAY_NUMBER_OF_COLUMNS   128
#define DISPLAY_TOTAL_PIXELS        (DISPLAY_NUMBER_OF_LINES * DISPLAY_NUMBER_OF_COLUMNS)

#define SCREEN_SCORE_NUMBER_OF_LINES    8
#define SCREEN_SCORE_NUMBER_OF_COLUMNS  128
#define SCREEN_SCORE_TOTAL_PIXELS       (SCREEN_SCORE_NUMBER_OF_LINES*SCREEN_SCORE_NUMBER_OF_COLUMNS)

#define SCREEN_VERTICAL_WALL_TOTAL_PIXELS   (DISPLAY_NUMBER_OF_LINES - SCREEN_SCORE_NUMBER_OF_LINES)   
#define SCREEN_HORIZONTAL_WALL_TOTAL_PIXELS DISPLAY_NUMBER_OF_COLUMNS
#define SCREEN_LEFT_WALL_TOTAL_PIXELS       SCREEN_VERTICAL_WALL_TOTAL_PIXELS    
#define SCREEN_RIGHT_WALL_TOTAL_PIXELS      SCREEN_VERTICAL_WALL_TOTAL_PIXELS
#define SCREEN_TOP_WALL_TOTAL_PIXELS        SCREEN_HORIZONTAL_WALL_TOTAL_PIXELS
...
#define C_OledLastLine_U8 0x40u

#define C_FirstLineAddress_U8 0xB8
#define C_LastLineAddress_U8 0xBF

#define C_DisplayDefaultDigits_U8 \
    0xffu  // Will display the exact digits in the number
#define C_MaxDigitsToDisplay_U8 \
    10u  // Max decimal/hexadecimal digits to be displayed
#define C_NumOfBinDigitsToDisplay_U8 \
    16u  // Max bits of a binary number to be displayed
 ...
 ****************************************************************************************************
 ...
 1.Required interfaces can be enabled/disabled by configuring its respective
 macros to 1/0.
 2. By default all the API's are disabled.
 3. Displaying of floating number takes huge controller resources and need to be
 enabled only if required. This implies for other interfaces as well.
 ****************************************************************************************************/
...
void OLED_VerticalGraph(uint8_t var_barGraphNumber_u8,
                        uint8_t var_percentageValue_u8);
void OLED_HorizontalGraph(uint8_t var_barGraphNumber_u8,
                          uint8_t var_percentageValue_u8);
/**************************************************************************************************/
