...
int main() {
    ...
    for (int i = 0; i < snakeHandler.size; i++) {
        drawBlock(snakeHandler.body[i].snakeSegment.xCoordinate,
                  snakeHandler.body[i].snakeSegment.yCoordinate,
                  snakeHandler.body[i].snakeSegment.status);
        _delay_ms(500);
    }
    ...
    for (;;) {
        ...
        //         drawBlock(snakeHandler.body[i].snakeSegment.xCoordinate,
        //         snakeHandler.body[i].snakeSegment.yCoordinate,
        //         snakeHandler.body[i].snakeSegment.status); _delay_ms(500);
        // }
        ...
        // if (snakeHandler.head.snakeSegment.yCoordinate == 15 ||
        // snakeHandler.head.snakeSegment.xCoordinate == 5)
        // {
        // OLED_Clear(); // clear the doScore()display (for good measure)
        // drawWall();
        ...
        // {
        //         // OLED_Printf("x %d y %d",
        //         snakeHandler.body[i].snakeSegment.xCoordinate,
        //         snakeHandler.body[i].snakeSegment.yCoordinate);
        //         drawBlock(snakeHandler.body[i].snakeSegment.xCoordinate,
        //         snakeHandler.body[i].snakeSegment.yCoordinate,
        //         snakeHandler.body[i].snakeSegment.status); _delay_ms(500);
