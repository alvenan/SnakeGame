...
void OLED_DisplayChar(uint8_t ch) {
    ...
    if (ch != '\n') /* TODO */
    {
        ...
        while (1) {
            dat = OledFontTable[ch][i]; /* Get the data to be
                          ...
                          after it */
        {
            ...
            if ((ch >= 0x30) && (ch <= 0x39)) {
                ...
                while ((ch >= 0x30) && (ch <= 0x39)) {
                    v_numOfDigitsToDisp_u8 =
                        (v_numOfDigitsToDisp_u8 * 10) + (ch - 0x30);
                    ptr++;
                    ch = *ptr;
                }
            } else {
            ...
            switch (ch) /* Decode the type of the argument */
            {
                ...
                case 'd': /* Argument type is of signed integer,
                    ...
                    if (v_num_s16 < 0) { /* If the number is -ve then
                                            display the 2's complement
                                            along with '-' sign */
                        v_num_s16 = -v_num_s16;
                        OLED_DisplayChar('-');
                    }
                    OLED_DisplayNumber(C_DECIMAL_U8, v_num_s16,
                                       v_numOfDigitsToDisp_u8);
                    break;
                ...
                case 'D': /* Argument type is of integer, hence
                    ...
                    if (v_num_s32 < 0) { /* If the number is -ve then
                                            display the 2's complement
                                            along with '-' sign */
                        v_num_s32 = -v_num_s32;
                        OLED_DisplayChar('-');
                    }
                    OLED_DisplayNumber(C_DECIMAL_U8, v_num_s32,
                                       v_numOfDigitsToDisp_u8);
                    break;
                ...
                case 'u': /* Argument type is of unsigned
                    ...
                    OLED_DisplayNumber(C_DECIMAL_U8, v_num_u16,
                                       v_numOfDigitsToDisp_u8);
                    break;
                ...
                case 'U': /* Argument type is of integer, hence
                    ...
                    OLED_DisplayNumber(C_DECIMAL_U8, v_num_u32,
                                       v_numOfDigitsToDisp_u8);
                    break;
                ...
                case 'x': /* Argument type is of hex, hence
                    ...
                    v_num_u16 = va_arg(argp, int);
                    OLED_DisplayNumber(C_HEX_U8, v_num_u16,
                                       v_numOfDigitsToDisp_u8);
                    break;
                ...
                case 'X': /* Argument type is of hex, hence
                             hexadecimal data from the argp */
                    v_num_u32 = va_arg(argp, uint32_t);
                    OLED_DisplayNumber(C_HEX_U8, v_num_u32,
                                       v_numOfDigitsToDisp_u8);
                    break;
                ...
                case 'b': /* Argument type is of binary,Read int
                    ...
                    OLED_DisplayNumber(C_BINARY_U8, v_num_u16,
                                       v_numOfDigitsToDisp_u8);
                    break;
                ...
                case 'B': /* Argument type is of binary,Read int
                    ...
                    if (v_numOfDigitsToDisp_u8 ==
                        C_MaxDigitsToDisplayUsingPrintf_U8)
                        v_numOfDigitsToDisp_u8 = 16;
                    OLED_DisplayNumber(C_BINARY_U8, v_num_u32,
                                       v_numOfDigitsToDisp_u8);
                    break;
